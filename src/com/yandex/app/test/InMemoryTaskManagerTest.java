...
class InMemoryTaskManagerTest {
    ...
    @BeforeAll
    public static void makeBeforeAll() {
...
//проверка, что утилитарный класс всегда возвращает проинициализированные и готовые к работе экземпляры менеджеров
    ...
    void shouldReturnSearchedTask() {
        ...
        assertEquals(newTask, inMemoryTaskManager.findTaskByID(19));
    }
    ...
    void shouldReturnSearchedEpic() {
        ...
        assertTrue(newEpic.getName().equals(inMemoryTaskManager.findEpicByID(18).getName())
                && newEpic.getDescription().equals(inMemoryTaskManager.findEpicByID(18).getDescription())
                && newEpic.getStatus().equals(inMemoryTaskManager.findEpicByID(18).getStatus())
                && newEpic.getSubtasksIDs().isEmpty()
                && 18 == inMemoryTaskManager.findEpicByID(18).getId()
        );
    }
    ...
    void shouldReturnSearchedSubtask() {
        ...
        assertTrue(newSubtask.getName().equals(inMemoryTaskManager.findSubtaskByID(20).getName())
                && newSubtask.getDescription().equals(inMemoryTaskManager.findSubtaskByID(20).getDescription())
                && newSubtask.getStatus().equals(inMemoryTaskManager.findSubtaskByID(20).getStatus())
                && newSubtask.getIdOfSubtaskEpic() == inMemoryTaskManager.findSubtaskByID(20).getIdOfSubtaskEpic()
                && 20 == inMemoryTaskManager.findSubtaskByID(20).getId()
        );
    }
